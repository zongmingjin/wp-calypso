...
import { billingHistory, purchasesRoot, pendingPurchases } from '../../paths.js';
	...
	return (
		<SectionNav selectedText={ text }>
			<NavTabs>
				...
				<NavItem path={ pendingPurchases } selected={ section === 'pending' }>
					{ i18n.translate( 'Pending Purchases' ) }
				</NavItem>
